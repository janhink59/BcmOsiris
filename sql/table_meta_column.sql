...
/*
    Tabulka meta_column slouží k uchování metadat sloupců/proměnných v databázi a aplikacích.
...
create table meta_column(
	...
	-- Varianta B: Pokud ancestor vyplněn není, MUSÍ být explicitně definovány vlastnosti.
	-- -------------------------------------------------------------------------
